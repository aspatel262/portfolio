const projects = [
    {
        ...
        image: '/project-data/project-image/studybuddy.jpeg',
        details: {
            ...
            techStack: [
                { name: 'React', link: 'https://reactjs.org', icon: '/assets/project-data/icons/react.svg' },
    ...
    },
    {
        ...
        image: '/src/assets/project-data/project-image/freepointer.png',
        details: {
