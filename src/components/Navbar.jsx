...
function NavbarMain() {
  ...
  const navbarStyle = {
    ...
    backgroundColor: isScrolled ? '#132230' : 'transparent',
  ...
  return (
    <Navbar style={navbarStyle} className="fixed top-0 z-50 w-full md:w-auto">
      ...
      {/* Mobile Menu */}
      <div
        className={`absolute top-[70px] left-0 w-full flex justify-center md:hidden transition-all duration-300 ease-in-out ${
      ...
      >
        <div className="bg-[rgba(0,34,48,0.85)] rounded-lg p-4 w-[90%] max-w-md shadow-lg">
          ...
          <div className="mt-4 grid grid-cols-2 gap-2">
            <a
              className="relative bg-gradient-to-r from-[#6a11cb] to-[#2575fc] hover:from-blue-600 hover:to-blue-800 hover:scale-105 text-white flex items-center justify-center h-12 rounded-md overflow-hidden group transition duration-200 ease-in-out"
              href="https://www.linkedin.com/in/adityapatel953/"
              target="_blank"
            ...
            <a
              className="relative bg-gradient-to-r from-[#555555] to-[#333333] hover:from-gray-700 hover:to-gray-600 hover:scale-105 text-white flex items-center justify-center h-12 rounded-md overflow-hidden group transition duration-200 ease-in-out"
              href="https://github.com/aspatel262"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              className="relative bg-gradient-to-r from-[#6fc2b0] to-[#28a79f] hover:from-[#28a79f] hover:to-[#6fc2b0] hover:scale-105 text-white flex items-center justify-center h-12 rounded-md overflow-hidden group transition duration-200 ease-in-out"
              href="mailto:aspatel262@gmail.com"
            >
            ...
            <a
              className="relative bg-gradient-to-r from-[#444444] to-[#999999] hover:from-[#999999] hover:to-[#444444] hover:scale-105 text-white flex items-center justify-center h-12 rounded-md overflow-hidden group transition duration-200 ease-in-out"
              href={res}
              target="_blank"
              rel="noopener noreferrer"
            >
