        ...
        <div className='hidden lg:flex fixed flex-col top-[35%] left-0'>
                <ul>
                    <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[2px] duration-300 bg-blue-600 rounded-2xl'>
                        <a className='flex pl-2 justify-between items-center w-full text-white' href='https://www.linkedin.com/in/adityapatel953/' target="_blank" rel="noopener noreferrer">
                    ...
                    <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[2px] duration-300 bg-[#333333] rounded-2xl'>
                        <a className='flex pl-2 justify-between items-center w-full text-white' href='https://github.com/aspatel262' target="_blank" rel="noopener noreferrer">
                    ...
                    <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[2px] duration-300 bg-[#6fc2b0] rounded-2xl'>
                        <a className='flex pl-2 justify-between items-center w-full text-white' href='mailto:aspatel262@gmail.com'>
                    ...
                    <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[2px] duration-300 bg-[#565f69] rounded-2xl'>
                        <a className='flex pl-2 justify-between items-center w-full text-white' href={ res } target="_blank">
